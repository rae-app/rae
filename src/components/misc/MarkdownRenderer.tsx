    ...
    <div className={className}>
      <ReactMarkdown
        ...
        components={{
          ...
          blockquote: ({ children }) => (
            <blockquote className="border-l-4 border-stone-300 dark:border-stone-600 pl-4 py-2 mb-3 italic text-stone-700 dark:text-stone-300 bg-stone-50 dark:bg-stone-800/50 rounded-r">
              {children}
            </blockquote>
          ),
          strong: ({ children }) => (
          ...
          em: ({ children }) => (
            <em className="italic text-foreground dark:text-stone-200">
              {children}
            </em>
          ),
          a: ({ href, children }) => (
